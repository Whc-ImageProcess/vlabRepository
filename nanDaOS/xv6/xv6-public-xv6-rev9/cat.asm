...
00000090 <cat>:
{
  ...
  c0:	53                   	push   %ebx
  c1:	e8 a5 02 00 00       	call   36b <read>
  ...
  d4:	50                   	push   %eax
  d5:	50                   	push   %eax
  d6:	68 18 08 00 00       	push   $0x818
  db:	6a 01                	push   $0x1
  dd:	e8 ce 03 00 00       	call   4b0 <printf>
    exit();
  e2:	e8 6c 02 00 00       	call   353 <exit>
  e7:	66 90                	xchg   %ax,%ax
  e9:	66 90                	xchg   %ax,%ax
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 48 08 00 00 	movzbl 0x848(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 3e 08 00 00       	mov    $0x83e,%ebx
        while(*s != 0){
